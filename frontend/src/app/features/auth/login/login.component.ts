...
/**
 * T049 — login page, step 1 (email + password). Mobile-first, Angular Material default theme (no
 * custom branding — deferred to feature 002, see tasks.md Notes). On success, hands the pre-auth
 * token off to LoginFlowState and navigates to the MFA challenge step (T050); the password step
 * alone never grants access (FR-015, mandatory MFA).
 */
@Component({
  selector: 'app-login',
  standalone: true,
