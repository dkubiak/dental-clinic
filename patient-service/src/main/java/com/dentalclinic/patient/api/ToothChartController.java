...
/**
 * {@code GET /patients/{patientId}/tooth-chart[/positions/{fdiNumber}/history]} per
 * contracts/patient-api.yaml (FR-005/FR-034). {@code @PreAuthorize} restricted to DOCTOR/ASSISTANT
 * (RECEPTION excluded, rbac-policy.md); deny→404.
 */
@RestController
