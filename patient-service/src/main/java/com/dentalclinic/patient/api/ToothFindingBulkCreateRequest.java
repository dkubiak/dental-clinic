...
/**
 * contracts/patient-api.yaml ToothFindingBulkCreateRequest schema (FR-004a-c, US6). The
 * {@code fdiNumbers} list is resolved client-side from a multi-select gesture (quadrant/arch/
 * segment shortcuts or drag-select) before the call is made.
 */
